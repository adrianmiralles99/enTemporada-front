...
@Component({
  selector: 'app-indiceperfilentradas',
  templateUrl: './indiceperfilentradas.component.html',
  styleUrls: ['./indiceperfilentradas.component.scss'],
  providers: [UsuarioService, TokenStorageService]

})
export class IndiceperfilentradasComponent implements OnInit {
